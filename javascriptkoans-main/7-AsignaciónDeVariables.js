...
describe('7-AsignaciónDeVariables.js', () => {
  ...
  it('ejercitemos las variables', () => {
    ...
    expect(resultado).toBe(3) // Acuérdate del módulo %
  })
  ...
  it('como se escriben los nombres de las variables', () => {
    ...
    let estaFraseLaVoyAEscribirComoNombreDeVariable = true
    expect(estaFraseLaVoyAEscribirComoNombreDeVariable).toBe(true) // Este esta solo para parar aquí, es fácil de solucionar ;)
